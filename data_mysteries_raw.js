...
export const mysteries = [
  ...
  },
  {
    id: "ms18",
    title: "张启山为何离开张家",
    question: "张启山出身神秘张家却出走南下，家中往事讳莫如深；其与张起灵的血脉关联、离族缘由未见完整交代（存疑）",
    status: "open",
    color: "#6e7d8c",
    timeline_ids: ["t84","t94"],
    note: "老九门、藏海花"
  },
  {
    id: "ms19",
    title: "二月红妻子之死真相",
    question: "丫头病逝令二月红心死退隐；病因为肺疾（剧版交代），小说版细节与「红妆」执念流传不一（存疑）",
    status: "partial",
    color: "#8c4a5e",
    timeline_ids: ["t88"],
    note: "已解答（剧版）／存疑"
  },
  {
    id: "ms20",
    title: "矿山古墓的青铜秘密",
    question: "矿山深处古墓出土带奇异纹饰的青铜器物，纹饰疑与张家族徽或汪藏海相关（存疑）；墓主身份与用途不明",
    status: "open",
    color: "#4a7d6a",
    timeline_ids: ["t86"],
    note: "老九门"
  },
  {
    id: "ms21",
    title: "九门为何没落、后代散落",
    question: "战乱、大火、迁徙与内斗令九门名号渐散：吴家迁杭、霍家北上、解家隐于商贾（约）",
    status: "partial",
    color: "#7a6f58",
    timeline_ids: ["t93","t94"],
    note: "老九门、正传卷一背景"
  },
  {
    id: "ms22",
    title: "霍家与张家的恩怨",
    question: "霍仙姑与张启山/上三门的恩怨纠葛众说纷纭，有嫁娶风波传说（存疑），真相未明",
    status: "open",
    color: "#8c4a5e",
    timeline_ids: ["t91"],
    note: "老九门"
  },
  {
    id: "ms23",
    title: "齐铁嘴与齐羽之名",
    question: "齐羽疑与齐铁嘴相关（名字关联），但齐家谱系未载，二人关系纯属猜测（存疑）",
    status: "open",
    color: "#556055",
    timeline_ids: ["t92","t95"],
    note: "老九门、正传卷八（齐羽相关）"
  },
  {
    id: "ms24",
    title: "张小鱼的身世与归宿",
    question: "张小鱼的叛徒烙印背后是何往事？他与张家本家、张起灵的血脉关系？霍文海府「同归于尽」真伪——大结局第30集他与张启山再现战场，假死之谜（《九门》剧版，存疑）",
    status: "partial",
    color: "#6e7d8c",
    timeline_ids: ["t96","t97","t98","t99"],
    note: "《九门》剧版原创线；用户特别关注"
  }
];
